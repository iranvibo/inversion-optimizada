...
- Contenido cargado por AJAX al abrir el tab (mismo patrón que la pestaña Actividad / `refreshActivities`): `GET /admin/users` (JSON), `DELETE /admin/users/{user}`. Controlador: `AdminUserController`.
