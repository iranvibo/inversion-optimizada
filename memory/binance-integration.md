...
10. **Selector de modo de trading real: Cross Margin vs Futuros (2026-06-18, España/EEE)**:
    ...
    - *Incidencia de Deuda Residual en Cross Margin (Diagnóstico 2026-06-25)*: Si una posición (p.ej. un SHORT) se cierra con pérdida o si hay deuda de colateral, puede quedar una deuda residual en el activo de margen (USDT/USDC). En Cross Margin, tener deuda activa en el activo de margen reduce su saldo libre (`free`) a 0. Como `getAvailableBalance()` lee el saldo `free`, el bot calculará un tamaño de posición de 0 en las siguientes operaciones, quedando "atascado" sin abrir posiciones nuevas. Solución: El usuario debe pagar la deuda de margen manualmente usando la opción "Repay" en Binance para restaurar el saldo libre.
